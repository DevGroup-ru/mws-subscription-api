 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSSubscriptionsService_Model_GetSubscription
 $request = new MWSSubscriptionsService_Model_GetSubscriptionInput();
 ...
 invokeGetSubscription($service, $request);
   ...
   * @param mixed $request MWSSubscriptionsService_Model_GetSubscription or array of parameters
   */
